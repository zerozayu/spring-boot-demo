...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest,
      com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest.class,
      responseType = com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest,
      com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest, com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest, com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest,
                com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse sayHello(com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse> sayHello(
        com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.zhangyu.grpc.hello.proto.HelloProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.zhangyu.grpc.hello.proto.HelloProto.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.zhangyu.grpc.hello.proto.HelloProto.getDescriptor();
    }
